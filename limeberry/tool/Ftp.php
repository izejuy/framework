	...
	class Ftp
	{
            ...
            */
            public function Rename($oldName=null, $newName=null)
            {
                    ...
                    }else { $this->ftpErrorLog = "Could not change name for file or directory ".$oldName;}
            }
            ...
            */
            public function CreateDirectory($dirName=null)
            {
                    ...
                    }else { $this->ftpErrorLog = "Please set a directory for this action";}
            }
            ...
            */
            public function DeleteFile($fileName=null)
            {
                    ...
                    }else { $this->ftpErrorLog = "Please set a filename for this action";}
            }
